 ...
 *         generated by methods of this class.
 * 
 * @method: __construct()                        -> Line 44 
 * @method: query( $query )                      -> Line 67 
 * @method: bind( $param, $value, $type = NULL ) -> Line 73  
 * @method: exectute()                           -> Line 103 
 * @method: fetch_all()                          -> Line 115 
 * @method: fetch_one()                          -> Line 122 
 * @method: row_count()                          -> Line 128 
 * @method: last_insert_id()                     -> Line 134 
 * @method: begin_transaction()                  -> Line 139 
 * @method: cancel_transaction()                 -> Line 157 
 * @method: end_transaction()                    -> Line 170
 * 
 */
class database
{
